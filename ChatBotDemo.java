			...
			public void actionPerformed(ActionEvent e) {
				if (e.getSource() == b) { // Message sents on Click button
					...
					if (text.contains("HI")) { // input Checking
						...
						replyMeth(
								"An aspirant has to appear for the KIITEE examination and has to secure the specified rank to get the specified branch");
						...
						replyMeth(
								"Kalinga Institute of Industrial Technologyformerly KIIT University, is a private deemed university located in Bhubaneswar, Odisha, India. It primarily emphasizes on higher education and research in engineering and science");
